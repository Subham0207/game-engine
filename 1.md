...
[PENDING] Load character and model only for now. Only create physics body on model if present. No animation logic should be there if there is no animation.
