        ...
        [PENDING] cannot serialize a lambda. Will Try Lua scripting with sol2 cpp binding to solve this.
            ...
            [PENIDNG] create statemachine in createnewproject instead of character constructor. Because we want to save animations to projet dir.
                ...
                [ISSUES]
                    ...
                    [PENDING] Destroy character object after saving creating new project. Because otherwise objects linger in memory and interfere with the loaded project. Like wrong playerController being used to control player since always 0th index one is used.
