...
6. [DONE] Fix: characterUI when opening an existing file it loads with nothing.
...
7. Saving Level
    Update create new project logic so the new logic works.
   Save model, transformation matrix, level specific guid.
   Save character, transformation matrix, level specific guid.
