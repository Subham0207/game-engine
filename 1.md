...
1. [PENDING] use the data generated to initialized nav mesh and render it.
2. [PENDING] implment path finding on this.
3. [INPROGRESS] NavMeshBuild.build function fails. Go through the DemoCode in recast library and Add tests in our project to make it functioning.
