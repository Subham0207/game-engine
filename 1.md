    ...
    [PENDING]save and load animStatemachine
        [PENDING] cannot serialize a lambda. Will Try Lua scripting with sol2 cpp binding to solve this.
            ...
            [PENIDNG] create statemachine in createnewproject instead of character constructor. Because we want to save animations to projet dir.
                ...
                5. load statemachine when character is loaded.
                [ISSUES]
                    ...
                    [PENDIG] animation not playing on movement inputs. The finalBoneMatrix values are always in T pose.
                    aniamtion.m_Rootnode is not but it is not even used. Check if boneInfoMap is being set ( should be since it just stores the offset matrix; if it was wrong the model would have deformed).
                    
                    [PENDIG] Lua script doesnot work.
