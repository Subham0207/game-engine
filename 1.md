...
[PENDING] Add different types of light sources.
    1. [DONE] Point light
        [PENDING] Add UI to update intensity, color of light.
    2. [DONE] Direction light
        [PENDING] Add UI to update intensity, color, direction of the light.
    3. [DONE] Spot Light
        [PENDING] Add UI to update intensity, color, direciton, inner and outer radius.
...
### Culling Lights
    1. Shadow maps for directional lights (cascaded shadow maps for sun).
    2. Shadow maps / shadow cubes for point lights (depth cubemap).
    3. Optionally spot light shadow maps (single depth texture).
## Shadow
