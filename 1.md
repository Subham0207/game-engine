...
[PARTIAL] Correct animation to play when turning and moving around. All movement input including diagonal are correctly applying on the physics capsule. Blendspace still broken.
[PENDING]Next is state machine
