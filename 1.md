...
7. Scripting treatment to AI class as well. Make it work again.
    Add Path Array pointers to empties in the level which will be used by the AI to patrol. This probably seems like something to be added from the AI derived class though...
