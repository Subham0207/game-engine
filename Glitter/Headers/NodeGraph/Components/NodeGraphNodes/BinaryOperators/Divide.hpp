...
#ifndef GLITTER_DIVIDE_HPP
#define GLITTER_DIVIDE_HPP
...
{
    class Divide: public NodeGraphNode
    {
    public:
        template<typename... Args>
        explicit Divide(int& nextInputPinId, int& nextOutputPinId, Args&&... args)
        ...
        NodeTypes type() override { return NodeTypes::Divide; }
