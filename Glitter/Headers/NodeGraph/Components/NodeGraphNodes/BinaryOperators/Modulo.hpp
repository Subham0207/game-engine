...
#ifndef GLITTER_MODULO_HPP
#define GLITTER_MODULO_HPP
...
{
    class Modulo: public NodeGraphNode
    {
    public:
        template<typename... Args>
        explicit Modulo(int& nextInputPinId, int& nextOutputPinId, Args&&... args)
        ...
        NodeTypes type() override { return NodeTypes::Modulo; }
